    ...
    <style>
        * {
        ...
        .code-container:hover {
            border-color: #413ad2;
            box-shadow: 0 5px 20px rgba(65, 58, 210, 0.15);
        }
        ...
        .code {
            ...
            text-shadow: 0 2px 4px rgba(65, 58, 210, 0.1);
            background: white;
            padding: 12px 20px;
            border-radius: 12px;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="code-container">
                ...
                <div class="timer">
                    <svg class="timer-icon" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="10" cy="10" r="9" stroke="#718096" stroke-width="1.5"/>
                        <path d="M10 5V10L13 13" stroke="#718096" stroke-width="1.5" stroke-linecap="round"/>
                    </svg>
                    <span>This code is valid for <strong>10 minutes</strong></span>
                </div>
            </div>
